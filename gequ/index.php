...
function mv(){
	...
	$output .= "</ul></div></div><div class=\"main\"></div>";
return $output;
}
//首页歌曲
function bang(){
	...
	$main .= "<div class=\"main\"><div style=\"float:left;\">网络歌曲飙升榜！</div><div style=\"float:right;\">更新时间：".$time."</div></div>";
...
function song_lrc($id){
	...
	$output = "<a href=\ target=\"_blank\"><img src=\" width=\"280px\" height=\"200px\"/></a>";
	}
return $output;
}
//大小转换//
...
<meta name="keywords" content="<?php echo $title?>,QQ空间背景音乐,歌曲外链,mp3外链,视频外链,背景音乐链接,外链,音乐外链" />
<meta name="description" content="<?php echo $title?>,千纸鹤◆有声有色免费提供音频试听，你可以分享给你的好友。同时生成的音乐外链链接支持引用到各大博客，网站，还可免费设置QQ空间背景音乐，免去你寻找歌曲链接地址的苦恼。" />
<style type="text/css">
/* 公共部分 */
...
.header .logo a{display:inline;float:left;width:143px;height:43px;background:url('./img/6b229b76jw1fb0zomp6k1g203z014t8h.gif');background-repeat:no-repeat;background-size:143px 43px;}
...
<!-- bottom Start -->
<div class="bottom"> 
<p>声明：本站不存储任何音频数据，站内歌曲来自搜索引擎，如有侵犯版权请及时联系我，我将在第一时间处理！</p>
<p><script language="javascript">var datatime=new Date(); document.write("&copy; 2018-"+datatime.getFullYear()+".");</script> 千纸鹤◆有声有色 <?php echo $lxfs;?> </p>
<p>反馈邮箱：413038027@139.com    <a href="http://www.wilsonzy.cn/Guestbook/index.html" title="留言板" target="_blank">留言板</a></p>
